                        ...
                        <div class="stats-card p-6">
                            ...
                            <div class="grid grid-cols-2 gap-y-3">
                                ...
                                <div>
                                    ...
                                    <div class="font-semibold"><?php echo htmlspecialchars($jugador['carreras_anotadas']); ?></div>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="font-semibold"><?php echo htmlspecialchars($jugador['atrapado_robando']); ?></div>
                                </div>
                                <div>
                                    <div class="text-sm text-gray-600">Bases por bolas</div>
                                    <div class="font-semibold"><?php echo htmlspecialchars($jugador['bases_por_bolas']); ?></div>
                                </div>
                                <div>
