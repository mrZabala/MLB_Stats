...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-05-2025 a las 20:01:37
...
INSERT INTO `ligas` (`id_de_la_liga`, `nombre_de_la_liga`) VALUES
(1, 'Liga Americana'),
(2, 'Liga Nacional');
...
INSERT INTO `equipos` (`id_del_equipo`, `nombre_del_equipo`, `abreviacion_del_equipo`, `id_de_la_liga`, `ubicacion_de_origen_del_equipo`, `fecha_del_primer_juego_del_equipo`, `juegos_ganados`, `juegos_perdidos`, `campeonato_ganados`) VALUES
(1, 'New York Yankees', 'NYY', 1, 'New York', '1903-04-22', 10846, 8270, 27),
(2, 'Boston Red Sox', 'BOS', 1, 'Boston', '1901-04-26', 9727, 9060, 9),
(3, 'Los Angeles Dodgers', 'LAD', 2, 'Los Angeles', '1884-05-01', 11123, 9891, 7),
(4, 'Chicago Cubs', 'CHC', 2, 'Chicago', '1876-04-25', 11093, 10537, 3);

--
-- Volcado de datos para la tabla `jugadores`
--

INSERT INTO `jugadores` (`id_del_jugador`, `nombre_del_jugador`, `edad_del_jugador`, `numero_del_jugador`, `id_del_equipo`, `id_de_la_liga`, `debut_del_jugador`, `genero_del_jugador`, `estatura_de_jugador`, `peso_del_jugador`, `fecha_nacimiento`, `posicion_del_jugador`, `mano_dominante_del_jugador`, `apodo_del_jugador`, `año_draft`) VALUES
(1, 'Aaron Judge', 32, 99, 1, 1, '2016-08-13', 'M', 201.00, 128.00, '1992-04-26', 'Jardinero derecho', 'Derecho', 'The Judge', 2013),
(2, 'Shohei Ohtani', 30, 17, 3, 2, '2018-03-29', 'M', 193.00, 95.00, '1994-07-05', 'Bateador designado/Lanzador', 'Ambidiestro', 'Showtime', 2018),
(3, 'Rafael Devers', 27, 11, 2, 1, '2017-07-25', 'M', 183.00, 108.00, '1996-10-24', 'Tercera base', 'Izquierdo', 'Carita', 2013),
(4, 'Dansby Swanson', 30, 7, 4, 2, '2016-08-17', 'M', 185.00, 86.00, '1994-02-11', 'Campocorto', 'Derecho', 'Dans', 2015);
...
--
ALTER TABLE `equipos`
  MODIFY `id_del_equipo` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `jugadores`
  MODIFY `id_del_jugador` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ligas`
--
ALTER TABLE `ligas`
  MODIFY `id_de_la_liga` int(11) NOT NULL AUTO_INCREMENT;
