...
.page-title, .hero-title, .best-of-the-best {
...
<body class="flex flex-col">
    ...
    <nav id="top" class="flex justify-between bg-gray-800 text-white p-4 items-center lg:p-8">
        <!-- LEFT Hand Side -->
        <div>
            <a href="index.php"><h1 class="page-title">MLB STATS</h1></a>
        </div>
        <!-- END LEFT Hand Side -->
    ...
    <section id="heroSection" class="max-h-[520px]">
        <div id="blackShadow" class="flex flex-col justify-center items-center h-full" >
            ...
            <p class="text-lg text-white mt-2 p-4 hero-paragraph lg:w-[850px] text-center">Tu centro para todo lo relacionado con el béisbol: desde estadísticas de jugadores y resultados de partidos hasta momentos históricos y noticias de última hora.</p>
    ...
    <section id="info" class="flex flex-col gap-4 p-4 lg:m-8 lg:flex-row">
        <div class="bg-white rounded-xl shadow-md p-6 flex flex-col gap-2">
            ...
            <p class="text-gray-600">Explora la rica historia y evolución moderna del béisbol. Desde los campos de tierra hasta los estadios, sigue el recorrido del deporte que marcó una nación.</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 flex flex-col gap-2">
            ...
            <p class="text-gray-600">Sumérgete en los promedios de bateo, ERA y estadísticas avanzadas para entender el juego más allá del marcador.</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 flex flex-col gap-2">
            ...
            <p class="text-gray-600">Selecciona tu equipo favorito y sigue cada jugada, estadística y posición en la tabla con nuestras herramientas personalizadas.</p>
        </div>
    </section>
    <!-- END Cards Section -->
    ...
    <section id="players" class="py-12 bg-gray-100">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden flex-1">
                <img src="assets/img/juan-soto.png" alt="Jugador 1" class="w-full h-60 object-cover">
                <div class="p-4">
                <h3 class="text-xl font-semibold mb-1 page-title">Juan Soto</h3>
                <p class="text-gray-600 mb-4 hero-paragraph">Jardinero Derecho</p>
                <a href="#" class="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">Ver más</a>
                </div>
            </div>

            <!-- Jugador 2 -->
            <div class="bg-white rounded-xl shadow-md overflow-hidden flex-1">
                <img src="assets/img/ohtani.png" alt="Jugador 2" class="w-full h-60 object-cover">
                <div class="p-4">
                <h3 class="text-xl font-semibold mb-1 page-title">Shohei Ohtani</h3>
                <p class="text-gray-600 mb-4 hero-paragraph">Lanzador / Bateador</p>
                <a href="#" class="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">Ver más</a>
                </div>
            </div>
            ...
            <!-- Jugador 3 -->
            <div class="bg-white rounded-xl shadow-md overflow-hidden flex-1">
                <img src="assets/img/tatisjr.png" alt="Jugador 3" class="w-full h-60 object-cover">
                <div class="p-4">
                <h3 class="text-xl font-semibold mb-1 page-title">Fernando Tatis Jr.</h3>
                <p class="text-gray-600 mb-4 hero-paragraph">Jardinero Derecho</p>
                <a href="#" class="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">Ver más</a>
                </div>
            </div>
